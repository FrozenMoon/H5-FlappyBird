...
class MCFactory {
    ...
    // 单例
	private static m_instance : MCFactory;
	public static Instance() : MCFactory 
	{
		if (MCFactory.m_instance == null)
		{
			MCFactory.m_instance = new MCFactory();
		}
		return MCFactory.m_instance;
	}
